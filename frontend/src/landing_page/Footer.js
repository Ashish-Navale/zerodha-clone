...
function Footer() {
    return(
        ...
        <div className='container border-top mt-5'>
            <div className='row align-items-start mt-5' style={{display:"flex"}}>   
                ...
                <div className='col footer-links'  style={{ textDecoration: "none", color: "#666" }}>
                    <p>Company</p>
                    <a href=" ">About</a><br />
